...
const Blog = () => {
  ...
  return (
    <section ref={sectionRef} id="blog" className="bg-darkgray-800 py-16">
      <div className="section-container">
        ...
        >
          ...
          <h2 className="section-title text-white">Artigos e Notícias</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {posts.map((post, index) => (
            <motion.div 
              key={index} 
              className="bg-darkgray-700 rounded-xl overflow-hidden shadow-subtle card-hover" 
              initial={{ opacity: 0, y: 20 }}
              animate={isVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
            ...
            >
              <div className="h-48 overflow-hidden">
                <div 
                  className="h-full w-full bg-darkgray-600 bg-cover bg-center transition-transform duration-500 hover:scale-105" 
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-3 line-clamp-2 text-white">{post.title}</h3>
                <p className="text-gray-300 mb-4 line-clamp-3">{post.excerpt}</p>
                <a href="#" className="inline-flex items-center text-turquoise font-medium hover:text-turquoise-400">
