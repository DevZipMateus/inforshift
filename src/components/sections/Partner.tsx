...
const Partner = () => {
  ...
  return (
    <section id="partner" className="py-16 bg-darkgray-800">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          >
            ...
            <Button 
              ...
              className="bg-turquoise hover:bg-turquoise-600 text-darkgray-900"
            >
              Saiba Mais
            </Button>
          </motion.div>
          ...
          >
            <img 
              ...
              src="/lovable-uploads/b5a81fce-c066-407a-98ee-db22e2901c07.png" 
            />
          </motion.div>
        </div>
      </div>
