      ...
      <main>
        <section className="pt-24 pb-16 bg-darkgray-800">
          <div className="section-container">
            <div className="flex flex-col items-center text-center mb-10">
              ...
              >
                <img 
                  ...
                  src="/lovable-uploads/db309268-f020-405e-8671-22fafb08b2d3.png" 
                />
              </motion.div>
            </div>
            
            <motion.div 
              className="bg-darkgray-700 rounded-xl shadow-elevation p-6 md:p-8 max-w-4xl mx-auto mb-10" 
              initial={{ opacity: 0, y: 20 }} 
              animate={{ opacity: 1, y: 0 }} 
            ...
            <motion.div 
              className="flex flex-col md:flex-row items-center justify-center gap-6 bg-darkgray-800 rounded-xl p-6 max-w-4xl mx-auto" 
              initial={{ opacity: 0, y: 20 }} 
              animate={{ opacity: 1, y: 0 }} 
