...
const PartnerPage = () => {
  return <motion.div initial={{
    ...
    opacity: 1
  }} className="overflow-hidden bg-darkgray-900">
      <Header />
      <main>
        <section className="pt-24 pb-16 bg-darkgray-800">
          <div className="section-container">
            <div className="flex flex-col items-center text-center mb-10">
              <motion.h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-white" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
              ...
              delay: 0.2
                ...
                <img alt="Premium Contábil" className="max-w-full h-auto max-h-60 object-contain mx-auto" src="/lovable-uploads/e9254d99-fb65-4324-b830-87f1d51c90a5.png" />
              </motion.div>
            </div>
            
            <motion.div className="bg-darkgray-700 rounded-xl shadow-elevation p-6 md:p-8 max-w-4xl mx-auto mb-10" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            <motion.div className="flex flex-col md:flex-row items-center justify-center gap-6 bg-darkgray-800 rounded-xl p-6 max-w-4xl mx-auto" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            delay: 0.4
              ...
              <div>
                <h3 className="text-xl font-bold mb-2 text-white">Contato:</h3>
                <p className="text-slate-300">Premium Contábil</p>
                <p className="text-slate-300">Fone: +55 82 99622-8340</p>
              </div>
              
              <Button asChild className="bg-turquoise hover:bg-turquoise-600 text-darkgray-900">
